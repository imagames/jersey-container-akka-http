...
libraryDependencies += "com.imagames" %% "jersey-container-akka-http" % "1.0.3"
```
...
dependencies {
    compile "com.imagames:jersey-container-akka-http_2.11:1.0.3" // Scala 2.11
    compile "com.imagames:jersey-container-akka-http_2.12:1.0.3" // Scala 2.12
}
```
